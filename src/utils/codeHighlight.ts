 ...
 *
 * 将纯文本 JS/TS 代码转换为带 <span> 标签的高亮 HTML 字符串。
...
/** 类名/全局对象（如 Cesium / THREE）→ c-code-class */
const CLASS_WORDS = new Set(['Cesium', 'THREE', 'Math']);

/** 场景内常用实例名 → c-code-camera */
const INSTANCE_WORDS = new Set(['viewer', 'camera', 'scene', 'entity', 'clock', 'dataSource']);
